...
public class Perceptron {
    ...
    //****************Gerando o somatorio do Y************************************
    public double somatorio(int entradas[]){
        double s = 0;
        
        for(int i=0; i< peso.length; i++){
            //Verifico se i é igual a zero, pois dessa forma a entrada Ã© igual a 1
            if(i==0){
                s += peso[i] * 1;
            }else{
    ...
    public void atualizarY(int entradas[][]){
        ...
        for(int i=0; i<entradas.length; i++){
            //função = se o resultado for >=0, logo resultado igual a 1, senão resultado igual a 0  
